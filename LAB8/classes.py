...
class Card(object):
    ...
    def __init__(self, name, attack, defense):
        ...
        500
        """
        # the name, attack, and defense values of the card
        self.name = name
        self.attack = attack
    ...
    def power(self, other_card):
        ...
        """
        "*** YOUR CODE HERE ***"
        # return the power which is the difference between the attack and defense / 2
...
class Player(object):
    def __init__(self, deck, name):
        ...
        self.name = name
        "*** YOUR CODE HERE ***"
        # for each card in the deck, draw 5 cards
    ...
    def draw(self):
        ...
        "*** YOUR CODE HERE ***"
        # draw a card from the deck and add (append) it to the hand
...
class TutorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        for _ in range(3):
            opponent.hand.pop(0)
        # print the name of the opponent and the number of cards they discarded and re-drew
        for _ in range(3): 
            opponent.draw()
...
class TACard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        300
        """
        # simple swap of attack and defense
...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        # for card in player.deck.cards, add the attack and defense of the opponent's card to the card
        for card in player.deck.cards:
            card.attack += other_card.attack
            card.defense += other_card.defense
        # for card in opponent deck, if attack and defense are the same as the opponent's card, remove the card or if defense is the same do the same
